...
/**
 * struct passinfo - has pseudo-arguements to pass to a function
 * @arg: getline containing arguements string
 ...
 * @status: return status of command executed last
 * @cmd_buf: pointer address to cmd_buf
 * @cmd_buf_type: CMD_type ||, &&, ;
 * @readfd: fd where line input is read
 * @histcount: num count hist line
 */
